...
const Modal = ({ isOpen, onClose }) => {
  ...
  const [currentReference, setCurrentReference] = useState({ title: '', authors: '', pdf_url: '', published: '' });
    ...
    <div className="modal-overlay">
      <div className="modal-content">
        <h2>Enter Reference</h2>
          <input type="text" name="title" placeholder="Title" value={currentReference.title} onChange={handleInputChange} required />
          <input type="text" name="authors" placeholder="Author" value={currentReference.authors} onChange={handleInputChange} required />
          <input type="text" name="pdf_url" placeholder="URL" value={currentReference.pdf_url} onChange={handleInputChange} required />
          <input type="text" name="published" placeholder="Published" value={currentReference.published} onChange={handleInputChange} required />
          <select onChange={handleSelectedStyle} value={style}  className="cite-lr">
            <option value="" disabled selected>Citation Type</option>
